...
public class ForbiddenAuthExceptionDiffblueTest {
  /**
   * Method under test:
   * {@link ForbiddenAuthException#ForbiddenAuthException(String)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link ForbiddenAuthException#ForbiddenAuthException(String, Throwable)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link ForbiddenAuthException#ForbiddenAuthException(String, Throwable, String[])}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link ForbiddenAuthException#ForbiddenAuthException(String, String[])}
   */
  @Test
