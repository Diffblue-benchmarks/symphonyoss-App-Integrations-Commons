...
public class WebHookDisabledExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link WebHookDisabledException#WebHookDisabledException(String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewWebHookDisabledException() {
    // Arrange and Act
    WebHookDisabledException actualWebHookDisabledException =
        new WebHookDisabledException("Configuration Type");
