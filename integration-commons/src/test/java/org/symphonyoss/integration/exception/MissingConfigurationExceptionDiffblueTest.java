...
public class MissingConfigurationExceptionDiffblueTest {
   ...
   * MissingConfigurationException#MissingConfigurationException(String, String, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewMissingConfigurationException() {
    // Arrange and Act
    MissingConfigurationException actualMissingConfigurationException =
        new MissingConfigurationException("Component", "An error occurred", "Solutions");
  ...
  public void testNewMissingConfigurationException2() {
    // Arrange and Act
    MissingConfigurationException actualMissingConfigurationException =
        new MissingConfigurationException("", "An error occurred", "Solutions");
  ...
  public void testNewMissingConfigurationException3() {
    // Arrange and Act
    MissingConfigurationException actualMissingConfigurationException =
        new MissingConfigurationException("Component", "", "Solutions");
  ...
  public void testNewMissingConfigurationException_thenReturnLocalizedMessageIsAString() {
    // Arrange and Act
    MissingConfigurationException actualMissingConfigurationException =
        new MissingConfigurationException("Component", "An error occurred", new String[] {});
   ...
   *
   * <p>Method under test: {@link
   * MissingConfigurationException#MissingConfigurationException(String, String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewMissingConfigurationException_whenComponent() {
    // Arrange and Act
    MissingConfigurationException actualMissingConfigurationException =
        new MissingConfigurationException("Component", "Key");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MissingConfigurationException.<init>(String, String)"})
  public void testNewMissingConfigurationException_whenEmptyString() {
    // Arrange and Act
    MissingConfigurationException actualMissingConfigurationException =
        new MissingConfigurationException("", "Key");
