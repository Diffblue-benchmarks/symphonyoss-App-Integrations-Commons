...
public class RemoteConfigurationExceptionDiffblueTest {
  /**
   * Test {@link RemoteConfigurationException#RemoteConfigurationException(String, Throwable, String[])}.
   * <p>
   * Method under test: {@link RemoteConfigurationException#RemoteConfigurationException(String, Throwable, String[])}
   */
  @Test
