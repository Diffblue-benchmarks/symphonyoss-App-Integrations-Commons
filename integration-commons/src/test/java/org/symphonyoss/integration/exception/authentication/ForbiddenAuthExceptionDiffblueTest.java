...
public class ForbiddenAuthExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ForbiddenAuthException#ForbiddenAuthException(String)}
   */
  @Test
  ...
  public void testNewForbiddenAuthException() {
    // Arrange and Act
    ForbiddenAuthException actualForbiddenAuthException = new ForbiddenAuthException("0123456789ABCDEF");
   ...
   * <p>
   * Method under test: {@link ForbiddenAuthException#ForbiddenAuthException(String, Throwable)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testNewForbiddenAuthException2() {
    ...
    // Act
    ForbiddenAuthException actualForbiddenAuthException = new ForbiddenAuthException("0123456789ABCDEF", cause);
   ...
   * <p>
   * Method under test: {@link ForbiddenAuthException#ForbiddenAuthException(String, Throwable, String[])}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link ForbiddenAuthException#ForbiddenAuthException(String, String[])}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
