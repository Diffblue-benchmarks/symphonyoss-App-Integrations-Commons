...
public class MetadataFieldDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MetadataField} (default constructor) Type is {@code null}.</li>
   *   <li>Then throw {@link MetadataParserException}.</li>
   * </ul>
   * <p>
   ...
   * Test {@link MetadataField#process(EntityObject, JsonNode)}.
   * <ul>
   *   <li>Then {@link EntityObject#EntityObject(String, String)} with {@code Type} and version is {@code 1.0.2} Content Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link MetadataField#process(EntityObject, JsonNode)}
   */
   ...
   * Test {@link MetadataField#process(EntityObject, JsonNode)}.
   * <ul>
   *   <li>Then {@link EntityObject#EntityObject(String, String)} with {@code Type} and version is {@code 1.0.2} Content {@code null} is empty string.</li>
   * </ul>
   * <p>
   * Method under test: {@link MetadataField#process(EntityObject, JsonNode)}
   */
