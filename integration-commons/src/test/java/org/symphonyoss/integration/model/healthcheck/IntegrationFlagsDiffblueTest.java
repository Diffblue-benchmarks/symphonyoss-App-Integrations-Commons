...
public class IntegrationFlagsDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link IntegrationFlags} (default constructor) AppCertificateInstalled is {@code NOK}.</li>
   ...
   * Test {@link IntegrationFlags#isUp()}.
   * <ul>
   *   <li>Given {@link IntegrationFlags} (default constructor) AppCertificateInstalled is {@link ValueEnum#NOT_APPLICABLE}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IntegrationFlags#isUp()}
   */
   ...
   * Test {@link IntegrationFlags#isUp()}.
   * <ul>
   *   <li>Given {@link IntegrationFlags} (default constructor) AppCertificateInstalled is {@link ValueEnum#OK}.</li>
   ...
   * Test {@link IntegrationFlags#isUp()}.
   * <ul>
   *   <li>Given {@link IntegrationFlags} (default constructor) ParserInstalled is {@code OK}.</li>
   *   <li>Then return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IntegrationFlags#isUp()}
   ...
   * Test {@link IntegrationFlags#isUp()}.
   * <ul>
   *   <li>Given {@link IntegrationFlags} (default constructor) UserAuthenticated is {@code NOK}.</li>
   *   <li>Then return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IntegrationFlags#isUp()}
   ...
   * Test {@link IntegrationFlags#isUp()}.
   * <ul>
   *   <li>Given {@link IntegrationFlags} (default constructor).</li>
   *   <li>Then return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IntegrationFlags#isUp()}
   ...
   */
  @Test
  @MethodsUnderTest({"void IntegrationFlags.<init>()", "ValueEnum IntegrationFlags.getAppCertificateInstalled()",
      "ValueEnum IntegrationFlags.getParserInstalled()", "ValueEnum IntegrationFlags.getUserAuthenticated()",
      "ValueEnum IntegrationFlags.getUserCertificateInstalled()",
      "void IntegrationFlags.setAppCertificateInstalled(ValueEnum)",
      "void IntegrationFlags.setParserInstalled(ValueEnum)", "void IntegrationFlags.setUserAuthenticated(ValueEnum)",
