...
public class LoadKeyStoreExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link LoadKeyStoreException#LoadKeyStoreException(String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewLoadKeyStoreException() {
    // Arrange and Act
    LoadKeyStoreException actualLoadKeyStoreException =
        new LoadKeyStoreException("An error occurred");
   ...
   *
   * <p>Method under test: {@link LoadKeyStoreException#LoadKeyStoreException(String, Exception)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewLoadKeyStoreException2() {
    ...
    // Act
    LoadKeyStoreException actualLoadKeyStoreException =
        new LoadKeyStoreException("An error occurred", cause);
  ...
  public void testNewLoadKeyStoreException3() {
    ...
    // Act
    LoadKeyStoreException actualLoadKeyStoreException =
        new LoadKeyStoreException("An error occurred", cause, "Solutions");
   ...
   *
   * <p>Method under test: {@link LoadKeyStoreException#LoadKeyStoreException(String, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewLoadKeyStoreException4() {
    // Arrange and Act
    LoadKeyStoreException actualLoadKeyStoreException =
        new LoadKeyStoreException("An error occurred", "Solutions");
