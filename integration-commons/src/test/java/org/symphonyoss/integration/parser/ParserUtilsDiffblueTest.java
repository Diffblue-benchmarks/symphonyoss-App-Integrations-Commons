...
public class ParserUtilsDiffblueTest {
  ...
  public void testBuildEncodedUrl_thenReturnHttpsExampleOrgExamplehttpsExampleOrgExample()
      throws MalformedURLException {
    // Arrange, Act and Assert
    assertEquals(
        "https://example.org/examplehttps://example.org/example",
        ParserUtils.buildEncodedUrl("https://example.org/examplehttps://example.org/example"));
  }
}
