...
public class MessageUtilsDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return Message {@code 42} is {@code null} is {@code Message not found for resource
   *       42.}.
   * </ul>
   *
   * <p>Method under test: {@link MessageUtils#MessageUtils(String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewMessageUtils_thenReturnMessage42IsNullIsMessageNotFoundForResource42() {
    ...
    assertEquals(
        "Message not found for resource 42.", new MessageUtils("foo.txt").getMessage("42", null));
  }
