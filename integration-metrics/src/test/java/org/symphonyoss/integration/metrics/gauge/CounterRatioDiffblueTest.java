...
public class CounterRatioDiffblueTest {
   ...
   * <p>
   * Method under test: {@link CounterRatio#CounterRatio(Counting, Counting)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link CounterRatio#getRatio()}
   */
  @Test
  ...
  public void testGetRatio() {
    ...
    // Act
    Ratio actualRatio = (new CounterRatio(numeratorMeter, denominatorMeter)).getRatio();
