...
public class MalformedParameterExceptionDiffblueTest {
  /**
   * Method under test:
   * {@link MalformedParameterException#MalformedParameterException(String, Throwable, String[])}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link MalformedParameterException#MalformedParameterException(String, String[])}
   */
  @Test
