...
public class StreamTypeNotFoundExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link StreamTypeNotFoundException#StreamTypeNotFoundException(String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewStreamTypeNotFoundException() {
    // Arrange and Act
    StreamTypeNotFoundException actualStreamTypeNotFoundException =
        new StreamTypeNotFoundException("An error occurred");
