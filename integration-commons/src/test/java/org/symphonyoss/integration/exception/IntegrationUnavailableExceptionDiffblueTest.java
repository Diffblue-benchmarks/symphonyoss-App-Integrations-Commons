...
public class IntegrationUnavailableExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link IntegrationUnavailableException#IntegrationUnavailableException(String)}
   */
  @Test
  ...
  /**
   * Test {@link IntegrationUnavailableException#IntegrationUnavailableException(String, String, String[])}.
   * <p>
   * Method under test: {@link IntegrationUnavailableException#IntegrationUnavailableException(String, String, String[])}
   */
  @Test
  ...
  @Test
  @MethodsUnderTest({"void IntegrationUnavailableException.<init>(String, String, String[])"})
  public void testNewIntegrationUnavailableException_whenNull() {
    // Arrange and Act
