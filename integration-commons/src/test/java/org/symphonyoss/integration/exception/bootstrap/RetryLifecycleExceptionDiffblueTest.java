...
public class RetryLifecycleExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link RetryLifecycleException#RetryLifecycleException(String,
   * Throwable)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewRetryLifecycleException() {
    ...
    // Act
    RetryLifecycleException actualRetryLifecycleException =
        new RetryLifecycleException("An error occurred", cause);
