...
public class IntegrationExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link IntegrationException#IntegrationException(String, String,
   * Throwable, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewIntegrationException() {
    ...
    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", cause, "Solutions");
  ...
  public void testNewIntegrationException2() {
    ...
    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", cause, "\n", "Component: ");
  ...
  public void testNewIntegrationException3() {
    ...
    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("", "An error occurred", cause, "Solutions");
  ...
  public void testNewIntegrationException4() {
    ...
    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "", cause, "Solutions");
  ...
  public void testNewIntegrationException6() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", "Solutions");
  ...
  public void testNewIntegrationException7() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", "\n", "Component: ");
  ...
  public void testNewIntegrationException8() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("", "An error occurred", "Solutions");
  ...
  public void testNewIntegrationException9() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "", "Solutions");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void IntegrationException.<init>(String, String)"})
  public void testNewIntegrationException_whenComponent2() {
    // Arrange and Act
    IntegrationException actualIntegrationException = new IntegrationException("Component", "");
  ...
  public void testNewIntegrationException_whenComponent_thenReturnLocalizedMessageIsAString() {
    ...
    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", cause, new String[] {});
  ...
  public void testNewIntegrationException_whenComponent_thenReturnLocalizedMessageIsAString2() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", new String[] {});
  ...
  public void testNewIntegrationException_whenEmptyString() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("", "An error occurred");
  ...
  public void testNewIntegrationException_whenEmptyString_thenReturnCauseIsThrowable() {
    ...
    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("", "An error occurred", cause);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void IntegrationException.<init>(String, String, Throwable)"})
  public void testNewIntegrationException_whenEmptyString_thenReturnCauseIsThrowable2() {
    // Arrange
    Throwable cause = new Throwable();

    // Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "", cause);
  ...
  public void testNewIntegrationException_whenNull_thenReturnCauseIsNull() {
    // Arrange and Act
    IntegrationException actualIntegrationException =
        new IntegrationException("Component", "An error occurred", (Throwable) null);
