...
public class ExceptionHandlerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When four hundred one.
   *   <li>Then return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link ExceptionHandler#unauthorizedError(int)}
   */
  @Test
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>When four hundred three.
   *   <li>Then return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link ExceptionHandler#forbiddenError(int)}
   */
  @Test
  @ManagedByDiffblue
