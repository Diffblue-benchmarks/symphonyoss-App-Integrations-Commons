...
public class UnexpectedAuthExceptionDiffblueTest {
  /**
   * Method under test:
   * {@link UnexpectedAuthException#UnexpectedAuthException(String)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link UnexpectedAuthException#UnexpectedAuthException(String, Throwable)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link UnexpectedAuthException#UnexpectedAuthException(String, Throwable, String[])}
   */
  @Test
