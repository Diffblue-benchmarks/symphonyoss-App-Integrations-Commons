...
public class SymphonyApiClientDiffblueTest {
   ...
   *
   * <p>Method under test: {@link SymphonyApiClient#init()}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testInit() {
    // Arrange
    MockSymphonyApiClient mockSymphonyApiClient =
        new MockSymphonyApiClient(ServiceName.POD_SESSION_MANAGER);
    ...
    assertTrue(
        ((ConnectivityApiClientDecorator) httpApiClient3).apiClient
            instanceof AuthenticationProxyApiClient);
   ...
   *
   * <p>Method under test: {@link SymphonyApiClient#buildHttpClient(String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testBuildHttpClient() {
    // Arrange and Act
    HttpApiClient actualBuildHttpClientResult =
        new MockSymphonyApiClient(ServiceName.POD_SESSION_MANAGER)
   ...
   *
   * <p>Method under test: {@link SymphonyApiClient#getClient()}
   */
  @Test
  @ManagedByDiffblue
