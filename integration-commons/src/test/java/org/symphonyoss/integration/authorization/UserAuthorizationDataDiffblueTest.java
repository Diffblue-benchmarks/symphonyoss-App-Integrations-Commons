...
public class UserAuthorizationDataDiffblueTest {
  ...
  @MethodsUnderTest({"void UserAuthorizationData.<init>()", "void UserAuthorizationData.<init>(String, Long)",
      "void UserAuthorizationData.<init>(String, Long, Object)", "Object UserAuthorizationData.getData()",
      "String UserAuthorizationData.getUrl()", "Long UserAuthorizationData.getUserId()",
      "void UserAuthorizationData.setData(Object)", "void UserAuthorizationData.setUrl(String)",
  ...
  /**
   * Test {@link UserAuthorizationData#equals(Object)}, and {@link UserAuthorizationData#hashCode()}.
   * <ul>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean UserAuthorizationData.equals(Object)", "int UserAuthorizationData.hashCode()"})
