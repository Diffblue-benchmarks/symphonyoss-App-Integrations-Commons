...
public class UnauthorizedUserExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link UnauthorizedUserException#UnauthorizedUserException(String)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link UnauthorizedUserException#UnauthorizedUserException(String, Throwable)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link UnauthorizedUserException#UnauthorizedUserException(String, Throwable, String[])}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link UnauthorizedUserException#UnauthorizedUserException(String, String[])}
   */
  @Test
