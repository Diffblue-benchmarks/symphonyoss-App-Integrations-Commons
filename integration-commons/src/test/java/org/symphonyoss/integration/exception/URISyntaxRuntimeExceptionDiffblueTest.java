...
public class URISyntaxRuntimeExceptionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link URISyntaxRuntimeException#URISyntaxRuntimeException(String, Throwable)}
   */
  @Test
  @MethodsUnderTest({"void URISyntaxRuntimeException.<init>(String)",
      "void URISyntaxRuntimeException.<init>(String, Throwable)", "void URISyntaxRuntimeException.<init>(Throwable)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link URISyntaxRuntimeException#URISyntaxRuntimeException(Throwable)}
   */
  @Test
  @MethodsUnderTest({"void URISyntaxRuntimeException.<init>(String)",
      "void URISyntaxRuntimeException.<init>(String, Throwable)", "void URISyntaxRuntimeException.<init>(Throwable)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link URISyntaxRuntimeException#URISyntaxRuntimeException(String)}
   */
  @Test
  @MethodsUnderTest({"void URISyntaxRuntimeException.<init>(String)",
      "void URISyntaxRuntimeException.<init>(String, Throwable)", "void URISyntaxRuntimeException.<init>(Throwable)"})
