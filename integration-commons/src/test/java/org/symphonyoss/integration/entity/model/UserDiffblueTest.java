...
public class UserDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIs10_thenReturnAttributesThirdValueIs104() {
    // Arrange
    User user = new User();
    user.setDisplayName("1.0");
    ...
    Attribute getResult = attributes.get(2);
    assertEquals("1.0", getResult.getValue());
    assertEquals("jane.doe@example.org", attributes.get(1).getValue());
    assertEquals(EntityConstants.DISPLAY_NAME_ENTITY_FIELD, getResult.getName());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIs42_thenReturnAttributesThirdValueIs424() {
    // Arrange
    User user = new User();
    user.setDisplayName("42");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIsAHref_thenReturnAttributesThirdValueIsLtAHref4() {
    // Arrange
    User user = new User();
    user.setDisplayName("<a href=");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIsBr_thenReturnAttributesThirdValueIsLtBrGt4() {
    // Arrange
    User user = new User();
    user.setDisplayName("<br/>");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIsDash_thenReturnAttributesThirdValueIsDash4() {
    // Arrange
    User user = new User();
    user.setDisplayName("-");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIsEmptyString5() {
    // Arrange
    User user = new User();
    user.setDisplayName("");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserDisplayNameIsNull5() {
    // Arrange
    User user = new User();
    user.setDisplayName(null);
    user.setEmailAddress("jane.doe@example.org");
  ...
  public void testToEntity_givenUserIdIsEight_thenReturnEntitiesFirstAttributesFirstValueIs8() {
    ...
    assertEquals(1, actualToEntityResult.getAttributes().size());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_givenUserIdIsOne_thenReturnEntitiesFirstAttributesFirstValueIs14() {
    // Arrange
    User user = new User();
    user.setId(1L);
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesSecondValueIsJohnSmithExampleOrg3() {
    // Arrange
    User user = new User();
    user.setId(1L);
    user.setEmailAddress("john.smith@example.org");
    ...
    List<Attribute> attributes2 = actualToEntityResult.getAttributes();
    assertEquals(2, attributes2.size());
    assertEquals("john.smith@example.org", attributes2.get(1).getValue());
    assertNull(getResult.getName());
    assertNull(getResult.getPresentationML());
    assertTrue(getResult.getEntities().isEmpty());
    assertEquals(EntityConstants.MENTION_TYPE, getResult.getType());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsAString4() {
    // Arrange
    User user = new User();
    user.setDisplayName(
        "<  a  href  =  \"http://UUUUUUUUUUUU//UU&amp;&amp;//UU&amp;&amp;\"  >xx</a>");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsAString5() {
    // Arrange
    User user = new User();
    user.setDisplayName(
        "<  a  href  =  \"http://UUUUUUUUUUUU//UU&amp;&amp;//UU&amp;&amp;\"  >xx</a>");
    ...
    assertEquals(
        "&lt;  a  href  =  &quot;<a href=\"http://UUUUUUUUUUUU//UU&amp;amp\">http://UUUUUUUUUUUU//UU&amp;amp</a"
            + ">;&amp;amp;//UU&amp;amp;&amp;amp;&quot;  &gt;xx&lt;/a&gt;",
        getResult.getValue());
    assertEquals("john.smith@example.org", attributes.get(1).getValue());
    assertEquals(EntityConstants.DISPLAY_NAME_ENTITY_FIELD, getResult.getName());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsComSymphonyIntegrationSS4() {
    // Arrange
    User user = new User();
    user.setDisplayName("com.symphony.integration.%s.%s");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsDash() {
    // Arrange
    User user = new User();
    user.setDisplayName("-");
    user.setEmailAddress("john.smith@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsDisplayName4() {
    // Arrange
    User user = new User();
    user.setDisplayName("Display Name");
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsUser_entity_field4() {
    // Arrange
    User user = new User();
    user.setDisplayName(EntityConstants.USER_ENTITY_FIELD);
    user.setEmailAddress("jane.doe@example.org");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Entity User.toEntity(String, String)"})
  public void testToEntity_thenReturnAttributesThirdValueIsUsername_entity_field4() {
    // Arrange
    User user = new User();
    user.setDisplayName(EntityConstants.USERNAME_ENTITY_FIELD);
    user.setEmailAddress("jane.doe@example.org");
