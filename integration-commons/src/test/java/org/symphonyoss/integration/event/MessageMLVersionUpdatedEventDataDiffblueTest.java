...
public class MessageMLVersionUpdatedEventDataDiffblueTest {
   ...
   * <ul>
   *   <li>{@link
   *       MessageMLVersionUpdatedEventData#MessageMLVersionUpdatedEventData(MessageMLVersion)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MessageMLVersionUpdatedEventData.<init>(MessageMLVersion)",
  ...
  public void testGettersAndSetters() {
    ...
    assertEquals(
        MessageMLVersion.V1,
        new MessageMLVersionUpdatedEventData(MessageMLVersion.V1).getVersion());
  }
}
